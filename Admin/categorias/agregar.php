...
$old = $_SESSION['old_categoria'] ?? [];
unset($_SESSION['errores_categoria'], $_SESSION['old_categoria']);
				...
				<form action="guardar.php" method="post" class="admin-form">
					<div class="admin-form-grid">
						<div class="admin-field">
							...
							<input type="text" id="nombre" name="nombre" maxlength="100" required value="<?php echo htmlspecialchars($old['nombre'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
						</div>
						...
						<div class="admin-field" style="grid-column: 1 / -1;">
							...
							<textarea id="descripcion" name="descripcion" maxlength="600" required><?php echo htmlspecialchars($old['descripcion'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
						</div>
					...
					<div class="admin-actions-row">
						<button type="submit" class="admin-btn">Guardar categoria</button>
